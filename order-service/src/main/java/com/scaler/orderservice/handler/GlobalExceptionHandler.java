package com.scaler.orderservice.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDto> handleOrderNotFound(OrderNotFoundException exception,
                                                        HttpServletRequest request) {
        return buildError(HttpStatus.NOT_FOUND, "ORDER_NOT_FOUND", exception.getMessage(), request, null);
    }

    @ExceptionHandler(InvalidOrderException.class)
    public ResponseEntity<ErrorDto> handleInvalidOrder(InvalidOrderException exception,
                                                       HttpServletRequest request) {
        return buildError(HttpStatus.BAD_REQUEST, "INVALID_ORDER", exception.getMessage(), request, null);
    }
